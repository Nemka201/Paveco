function BeneficiosCard({...props}){
  ...
  const list = values.map((value, index) => 
    <h2 className="ps-2 pt-4" key={index}><i className="fa-solid fa-arrow-right pe-4" style={{color: "white"}}></i>{value}</h2>);
  return (
    <>
      <div className="col-4 pe-lg-3 ps-lg-3 pt-5 ps-4 pe-3 col-12 col-sm-12 col-md-12 col-lg-12 col-xl-4">
        ...
        <i className="fa-solid fa-circle-check b-icon" style={{color: "#00ff22",fontSize: "50px",}}></i>
          {list}
        </div>
      </div>
    </>
